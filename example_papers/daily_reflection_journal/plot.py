...
plots: Dict[str, Dict[str, Union[str, Dict[str, str]]]] = {
    "Reflection Effectiveness Over Time": {
        "filename": "reflection_effectiveness",
        "plot_type": "bar",
        "question": "Did the app help you reflect on your day?",
        "runs": {
            "run_1": "Run 1: Basic MVP",
            "run_2": "Run 2: Fixed Core Functionality",
            "run_3": "Run 3: Added Mood Tracking",
            "run_4": "Run 4: Expanded Mood Options",
            "run_5": "Run 5: Final Features"
        },
    },
    "Ease of Use Ratings Over Time": {
    ...
    "Streak Motivation Over Time": {
        "filename": "streak_motivation",
        "plot_type": "bar",
    ...
    "Final Ease of Use Breakdown": {
        "filename": "final_ease_of_use",
        "plot_type": "pie",
        "question": "How would you rate the ease of use of the app?",
        "runs": {
            "run_5": "Final Version"
